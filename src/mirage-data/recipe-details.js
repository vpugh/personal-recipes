{
  [
    ...
    },
    {
      ...
      serveType: '',
      description:
        "With a buttery crust and luscious lemon curd, these tangy lemon bars taste like a fancy French tart in bar form. They happen to be gluten-free too. But if gluten isn't an issue for you, replace the sweet rice, oat, and tapioca flours with 140 grams (about 1 cup + 2 tablespoons) all-purpose wheat flour. We love this delightful recipe especially during the winter when citrus is at it's best and short days are brighter with a sweet treat.",
      recipeOrigin:
        'https://www.vermontcreamery.com/recipes/gluten-free-lemon-bars-with',
      equipmentNeeded: [],
      ingredients: [
        ...
        '6 tablespoons Vermont Creamery Unsalted Cultured Butter - 82% Butterfat cold and in 1/2-inch dice',
        ...
        'optional garnishes powdered sugar, lemon wheels, and/or heavy cream and crème fraîche whipped to firm peaks'
      ],
      instructions: [
        'Crust - Position a rack in the center of the oven and preheat to 350°F. Line an 8-inch square pan with parchment paper on all sides.',
        ...
        'Filling - Lower the oven temperature to 325°F.',
        ...
        'Place the pot over medium-low heat and cook, stirring constantly with a heatproof silicone spatula, until the mixture thickens slightly and reaches 160-165°F on an instant-read thermometer, 5-10 minutes. As you stir, be sure to scrape the entire bottom and corners of the pan, so that the mixture heats as evenly as possible. It will start out thick and cloudy from the undissolved sugar, then will turn thin and translucent, and finally begin to thicken and turn cloudy again as the eggs cook. Lower the heat to very low as it gets closer to being done. If the mixture starts to curdle or bubble, immediately remove it from the heat and proceed to the next step.',
    ...
    },
    {
      ...
      recipeOrigin: 'https://lowcarbyum.com/bacon-ranch-chicken-crust-pizza/',
      equipmentNeeded: [],
      ingredients: [
      ...
      notes:
        'A silicone baking mat can be used instead of the parchment paper to roll-out the crust and flip easily after the initial baking. To make things easier, a prepared Ranch dressing can be used instead of making it from scratch.'
    },
    {
      prepTime: 5,
      cookTime: 15,
      ...
      notes:
        'Alyssa Also Recommends: Want to make this even easier? Here are a few products that I LOVE: Finedine Mixing Bowls, Calphalon Cookware Set, Staub Cast Iron Skillet'
    },
    {
      prepTime: 15,
      cookTime: null,
      ...
      serveType: '',
      description:
        'How does dinner in fifteen minutes sound? How about if it’s a delicious pasta with layers of flavor that’s made entirely in one pot? Even better! Our One Pot Caprese Pasta is all of those things and more. With tender linguine, fresh mozzarella, basil, and a touch of balsamic, it’s like a comforting carby version of a great caprese salad. But it has a few other tricks up its sleeve (and it couldn’t be easier to make).',
      recipeOrigin: 'https://12tomatoes.com/one-pot-caprese-pasta',
      equipmentNeeded: [],
      ingredients: [
        '8 oz dry linguine',
    ...
    },
    {
      ...
      recipeOrigin: 'https://www.youtube.com/watch?v=D_fYk8mBaF4',
      equipmentNeeded: [],
      ingredients: [
      ...
      instructions: [
        'Take the boneless chicken pieces in a bowl, add lemon juice, hung curd, ginger garlic paste, red chili powder, garam masala, salt',
        'Mix everything well, and marinate the chicken for about 30 minutes ',
        'Heat a pan and add some oil ',
        'Fry the chicken pieces till they are cooked and keep them aside',
        'In a pan  heat some oil and butter, add onions, ginger, garlic and saute them',
        'Once they are golden brown, add tomatoes, cashews and saute them',
        'Add kashmiri red chilies, cumin powder, coriander powder, garam masala powder, salt cook them with little water',
        'Once they are cooked, cool them and grind them to a fine puree',
        'Heat the same pan, add some butter, red chili powder and add the puree onto the pan ',
        'Bring the gravy to a boil, add the fried chicken pieces and fresh cream and simmer the gravy for about 10 minutes',
    ...
    },
    {
      ...
      recipeOrigin: 'https://tasty.co/recipe/lemon-bundt-cake',
      equipmentNeeded: [],
      ingredients: [
    ...
    },
    {
      ...
      recipeOrigin: 'https://fitfoodiefinds.com/fajita-breakfast-burritos',
      equipmentNeeded: [],
      ingredients: [
    ...
    },
    {
      ...
      recipeOrigin: 'https://cafedelites.com/chocolate-pecan-pie',
      equipmentNeeded: [],
      ingredients: [
        '2 cups pecans',
    ...
    },
    {
      ...
      recipeOrigin: 'https://tasty.co/recipe/apple-cider-beignet',
      equipmentNeeded: [],
      ingredients: [
        '1 ½ cups apple cider',
